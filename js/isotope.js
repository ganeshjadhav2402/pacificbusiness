...
(function(t) {
  ...
  "function" == typeof define && define.amd
    ...
    : "object" == typeof exports ? i(require("jquery")) : i(t.jQuery);
})(window), (function(t) {
  function e(e) {
    var i = t.event;
  ...
  function n(i) {
    function n() {
      if (!d) {
        ...
        if (
          ...
          (n.style.width = "200px"), (n.style.padding =
            "1px 2px 3px 4px"), (n.style.borderStyle =
            "solid"), (n.style.borderWidth = "1px 2px 3px 4px"), (n.style[h] =
            "border-box");
    ...
    function a(t) {
      if (
        ...
        var S = e(i.height);
        return S !== !1 && (r.height = S + (b ? 0 : v + z)), (r.innerWidth =
          r.width - (g + L)), (r.innerHeight =
          r.height - (v + z)), (r.outerWidth = r.width + _), (r.outerHeight =
          r.height + I), r;
      }
    }
    function u(e, i) {
      ...
      var o = e.style,
        ...
        r = e.runtimeStyle,
        s = r && r.left;
      return s && (r.left = e.currentStyle.left), (o.left = i), (i =
        o.pixelLeft), (o.left = n), s && (r.left = s), i;
    }
    var p,
      h,
      f,
  ...
  function s(i, s, f, l, c, y) {
    ...
    return (m.namespace = "outlayer"), (m.Item = y), (m.defaults = {
      ...
      delete v[n], delete this.element.outlayerGUID, p &&
  ...
  function r(t, i, r, u, h) {
    ...
    (d.Item = u), (d.LayoutMode = h), (d.prototype._create = function() {
      ...
      var o = this;
      this._isInstant
        ? this._noTransition(e)
        : e(), this._sort(), this._layout();
    }), (d.prototype._init =
      d.prototype.arrange), (d.prototype._getIsInstant = function() {
      var t =
        void 0 !== this.options.isLayoutInstant
          ? this.options.isLayoutInstant
          : !this._isLayoutInited;
      ...
      for (
        ...
        if (!u.isIgnored) {
          var p = r(u);
          p && i.push(u), p && u.isHidden
            ? o.push(u)
            : p || u.isHidden || n.push(u);
        }
      }
