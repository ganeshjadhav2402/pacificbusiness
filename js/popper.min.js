 ...
 */ (function(
  ...
  function u(e, o) {
    ...
    if (((u.marginTop = 0), (u.marginLeft = 0), !r && p)) {
      ...
      (u.top -= m - b), (u.bottom -= m - b), (u.left -= h - y), (u.right -=
        h - y), (u.marginTop = b), (u.marginLeft = y);
    }
    return (r && !i ? o.contains(a) : o === a && "BODY" !== a.nodeName) &&
      (u = l(u, o)), u;
  }
  function b(e) {
    ...
    if ("viewport" === r) s = b(a, p);
      ...
      if ("HTML" === l.nodeName && !y(a)) {
        var m = h(),
          c = m.height,
          g = m.width;
        (s.top += f.top - f.marginTop), (s.bottom = c + f.top), (s.left +=
  ...
  function T(e, t, o) {
    ...
    var n = L(e),
      ...
      a = r ? "width" : "height";
    return (i[p] =
      t[p] + t[d] / 2 - n[d] / 2), (i[s] = o === s ? t[s] - n[a] : t[S(s)]), i;
  }
  function D(e, t) {
  ...
  function k() {
    if (!this.state.isDestroyed) {
      ...
      (e.offsets.reference = O(
        ...
        e.placement), (e.positionFixed = this.options.positionFixed), (e.offsets.popper = T(
        this.popper,
        e.offsets.reference,
        e.placement
      )), (e.offsets.popper.position = this.options.positionFixed
        ? "fixed"
        : "absolute"), (e = N(this.modifiers, e)), this.state.isCreated
  ...
  function F(e, t) {
    return H(e).removeEventListener(
      "resize",
      t.updateBound
  ...
  return (me.Utils = ("undefined" == typeof window
    ? global
    : window).PopperUtils), (me.placements = ae), (me.Defaults = {
    placement: "bottom",
    positionFixed: !1,
    eventsEnabled: !0,
    removeOnDestroy: !1,
    ...
    modifiers: {
      ...
      inner: {
        ...
        fn: function(e) {
          ...
          return (i[p ? "left" : "top"] =
            r[o] - (s ? i[p ? "width" : "height"] : 0)), (e.placement = S(
            t
      ...
      computeStyle: {
        ...
        fn: function(e, t) {
          ...
          return (e.attributes = de({}, E, e.attributes)), (e.styles = de(
            {},
            m,
            e.styles
          )), (e.arrowStyles = de({}, e.offsets.arrow, e.arrowStyles)), e;
        },
        gpuAcceleration: !0,
        x: "bottom",
        y: "right"
