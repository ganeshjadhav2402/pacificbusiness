  ...
  a.extend(a.fn, {
              ...
              (
                this.on("click.validate", ":submit", function(b) {
                  c.settings.submitHandler &&
                    (c.submitButton =
                      b.target), a(this).hasClass("cancel") && (c.cancelSubmit = !0), void 0 !== a(this).attr("formnovalidate") && (c.cancelSubmit = !0);
                }),
                this.on("submit.validate", function(b) {
                  ...
                  return c.settings.debug &&
                    b.preventDefault(), c.cancelSubmit ? ((c.cancelSubmit = !1), d()) : c.form() ? (c.pendingRequest ? ((c.formSubmitted = !0), !1) : d()) : (c.focusInvalid(), !1);
                })
              ),
            c
          );
    ...
    rules: function(b, c) {
      ...
      if (b)
        switch ((
          ...
          case "add":
            a.extend(f, a.validator.normalizeRule(c)), delete f.messages, (e[
              j.name
            ] = f), c.messages &&
              ...
              ? (
                  ...
                  a.each(c.split(/\s/), function(b, c) {
                    (i[c] =
                      f[
                        c
                      ]), delete f[c], "required" === c && a(j).removeAttr("aria-required");
                  }),
                  i
                )
              : (delete e[j.name], f);
        }
      return (g = a.validator.normalizeRules(
        a.extend(
          {},
        ...
        ((h = g.remote), delete g.remote, (g = a.extend(g, { remote: h }))), g;
    }
  }), a.extend(a.expr[":"], {
    blank: function(b) {
    ...
    prototype: {
      init: function() {
        ...
        (this.labelContainer = a(
          ...
          a(this.currentForm)), (this.containers = a(
        ...
        a.each(this.settings.groups, function(b, c) {
          "string" == typeof c && (c = c.split(/\s/)), a.each(c, function(
            a,
            c
          ) {
            d[c] = b;
      ...
      form: function() {
        return this.checkForm(), a.extend(
          this.submitted,
          this.errorMap
        ), (this.invalid = a.extend({}, this.errorMap)), this.valid() ||
      ...
      errorsFor: function(b) {
        ...
        return d &&
          (e = e + ", #" + d.replace(/\s+/g, ", #")), this.errors().filter(e);
      },
      idOrName: function(a) {
        return (
    ...
    staticRules: function(b) {
      ...
      return d.settings.rules &&
        (c = a.validator.normalizeRule(d.settings.rules[b.name]) || {}), c;
    },
    ...
    addMethod: function(b, c, d) {
      (a.validator.methods[b] = c), (a.validator.messages[b] =
        void 0 !== d ? d : a.validator.messages[b]), c.length < 3 &&
    ...
    methods: {
      ...
      creditcard: function(a, b) {
        ...
        for (c = a.length - 1; c >= 0; c--)
          (d = a.charAt(c)), (f = parseInt(d, 10)), g &&
            (f *= 2) > 9 &&
            (f -= 9), (e += f), (g = !g);
        return e % 10 === 0;
      },
      ...
      remote: function(b, c, d) {
        ...
        return this.settings.messages[c.name] ||
          ...
          c.name
        ].remote), (this.settings.messages[c.name].remote = g.message), (d =
          ("string" == typeof d && { url: d }) || d), g.old === b
          ? g.valid
          : (
              (g.old = b),
              (e = this),
  ...
  (e.fn.attr2 = function() {
    ...
    function o(a) {
      ...
      return (s.beforeSend = function(e, r) {
        t.formData ? (r.data = t.formData) : (r.data = n), c &&
          c.call(this, e, r);
      }), e.ajax(s);
    }
    function s(r) {
