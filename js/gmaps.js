...
!(function(a, b) {
  ...
  var a = function(a, b) {
    ...
    b = function(a, b) {
      ...
      if (Array.prototype.map && a.map === Array.prototype.map)
        ...
        for (c = 0; f > c; c++)
          (callback_params = d), callback_params.splice(0, 0, a[c]), e.push(
        ...
        d = function(b) {
          ...
          for (
            window.context_menu =
              ...
              f.el.id
            ] = {}, this.controls = [], this.overlays = [], this.layers = [], this.singleLayers = {}, this.markers = [], this.polylines = [], this.routes = [], this.polygons = [], this.infoWindow = null, this.overlay_el = null, this.zoom =
              b.zoom, this.registered_events = {}, this.el.style.width =
              b.width ||
              this.el.scrollWidth ||
              this.el.offsetWidth, this.el.style.height =
              b.height ||
              this.el.scrollHeight ||
              this.el.offsetHeight, google.maps.visualRefresh =
              b.enableNewStyle, e = 0;
            e < l.length;
            e++
          )
            delete b[l[e]];
          ...
          (this.map = new google.maps.Map(this.el, z)), n &&
          ...
          var C = function(a, b) {
            ...
            if (h("gmaps_context_menu")) {
              ...
              for (e = 0; l > e; e++) {
                var m = k[e],
                  n = function(c) {
                    c.preventDefault(), d[
                      this.id.replace(a + "_", "")
                    ].action.apply(f, [b]), f.hideContextMenu();
                  };
              ...
              var o = i.apply(this, [f.el]),
                p = o[0] + b.pixel.x - 15,
                q = o[1] + b.pixel.y - 15;
              (j.style.left = p + "px"), (j.style.top =
                q + "px"), (j.style.display = "block");
            }
          };
          (this.buildContextMenu = function(a, b) {
            ...
            (d.id = "gmaps_context_menu"), (d.style.display =
              "none"), (d.style.position = "absolute"), (d.style.minWidth =
              "100px"), (d.style.background = "white"), (d.style.listStyle =
              "none"), (d.style.padding = "8px"), (d.style.boxShadow =
              "2px 2px 6px #ccc"), c.body.appendChild(d);
          ...
          var D = function(a, c) {
            google.maps.event.addListener(a, c, function(a) {
              void 0 == a &&
                (a = this), b[c].apply(this, [a]), f.hideContextMenu();
            });
          };
          ...
          google.maps.event.addListener(this.map, "rightclick", function(a) {
            ...
            (a = a || 1), (this.zoom =
              this.map.getZoom() + a), this.map.setZoom(this.zoom);
  ...
  (j.prototype.createControl = function(a) {
    ...
    (b.style.cursor = "pointer"), a.disableDefaultStyles !== !0 &&
      (
    ...
    a.id && (b.id = a.id), a.classes && (b.className = a.classes), a.content &&
      ("string" == typeof a.content
        ? (b.innerHTML = a.content)
        : a.content instanceof HTMLElement &&
          b.appendChild(a.content)), a.position &&
        ...
        b[d] &&
          google.maps.event.addListener(c, d, function(c) {
            c.pixel ||
              (c.pixel = a
                .getProjection()
                .fromLatLngToPoint(c.latLng)), b[d].apply(this, [c]);
          });
      })(this.map, i, m[k]);
    ...
    return b.setMap(this.map), this.markerClusterer &&
      this.markerClusterer.addMarker(b), this.markers.push(b), j.fire(
      "marker_added",
      b,
      this
    ), b;
    ...
    for (var b = 0; b < this.markers.length; b++)
      if (this.markers[b] === a) {
        this.markers[b].setMap(null), this.markers.splice(b, 1), this
          .markerClusterer && this.markerClusterer.removeMarker(a), j.fire(
          "marker_removed",
          a,
          this
        );
    ...
    if ("undefined" == typeof a) {
      for (var c = 0; c < this.markers.length; c++) {
        ...
        d.setMap(null), this.markerClusterer &&
          this.markerClusterer.removeMarker(d), j.fire(
          "marker_removed",
          d,
          this
        );
    ...
    var b = new google.maps.OverlayView(),
      c = !0;
    return b.setMap(this.map), null != a.auto_show &&
      (c = a.auto_show), (b.onAdd = function() {
      var c = document.createElement("div");
      (c.style.borderStyle = "none"), (c.style.borderWidth =
        "0px"), (c.style.position =
        "absolute"), (c.style.zIndex = 100), (c.innerHTML =
        a.content), (b.el = c), a.layer || (a.layer = "overlayLayer");
      var d = this.getPanes(),
        e = d[a.layer],
    ...
    a.hasOwnProperty("clickable") &&
      (f.clickable = a.clickable), a.hasOwnProperty("editable") &&
      (f.editable = a.editable), a.hasOwnProperty("icons") &&
      (f.icons = a.icons), a.hasOwnProperty("zIndex") && (f.zIndex = a.zIndex);
    for (
    ...
    for (var b = 0; b < this.polylines.length; b++)
      if (this.polylines[b] === a) {
        this.polylines[b].setMap(null), this.polylines.splice(b, 1), j.fire(
          "polyline_removed",
          a,
          this
        );
    ...
    var e = !1;
    d.hasOwnProperty("useGeoJSON") &&
      (e = d.useGeoJSON), delete d.useGeoJSON, (d = a(
      { map: this.map },
      d
    )), 0 == e && (d.paths = [d.paths.slice(0)]), d.paths.length > 0 &&
      d.paths[0].length > 0 &&
    ...
    for (var b = 0; b < this.polygons.length; b++)
      if (this.polygons[b] === a) {
        this.polygons[b].setMap(null), this.polygons.splice(b, 1), j.fire(
          "polygon_removed",
          a,
          this
        );
    ...
    switch (a) {
      ...
      case "bicycling":
        ...
        break;
      case "panoramio":
        (this.singleLayers.panoramio = c = new google.maps.panoramio
          .PanoramioLayer()), c.setTag(b.filter), delete b.filter, b.click &&
      ...
      case "places":
        if (
          (
            (this.singleLayers.places = c = new google.maps.places
          ...
          b.radarSearch && c.radarSearch(d, b.radarSearch), b.search &&
            c.search(d, b.search), b.nearbySearch &&
  ...
  return (j.prototype.getRoutes = function(b) {
    ...
    (d = a({ locations: [], path: !1, samples: 256 }, d)), d.locations.length >
      0 &&
    ...
    if (d.path) {
      ...
      delete d.path, delete d.samples, g.getElevationForLocations(d, function(
        a,
        b
      ) {
        e && "function" == typeof e && e(a, b);
      });
  }), (j.prototype.cleanRoute = j.prototype.removePolylines), (j.prototype.drawRoute = function(
    a
  ) {
    var b = this;
    this.getRoutes({
      ...
      callback: function(c) {
        if (c.length > 0) {
          ...
          a.hasOwnProperty("icons") && (d.icons = a.icons), b.drawPolyline(
            d
    ...
    if (a.origin && a.destination)
            ...
            if (d.legs.length > 0)
              for (var e, f = d.legs[0].steps, g = 0; (e = f[g]); g++) {
                ...
                a.hasOwnProperty("icons") &&
                  (h.icons = a.icons), b.drawPolyline(h), a.step(
                  e,
                  d.legs[0].steps.length - 1
                );
              }
          }
      ...
      for (var c, d = a.route.legs[0].steps, e = 0; (c = d[e]); e++) {
        ...
        a.hasOwnProperty("icons") && (f.icons = a.icons), b.drawPolyline(
          f
        ), a.step(c);
      }
  }), (j.Route = function(a) {
    (this.origin = a.origin), (this.destination =
      a.destination), (this.waypoints = a.waypoints), (this.map =
      a.map), (this.route =
      a.route), (this.step_count = 0), (this.steps = this.route.legs[0].steps), (this.steps_length = this.steps.length);
    var b = {
    ...
    a.hasOwnProperty("icons") &&
      (b.icons = a.icons), (this.polyline = this.map.drawPolyline(b).getPath());
    ...
    if (this.polylines.length > 0) {
      ...
      (b.polyline = {}), (b.polyline.path = google.maps.geometry.encoding.encodePath(
        d.getPath()
      )), (b.polyline.strokeColor = d.strokeColor), (b.polyline.strokeOpacity =
    ...
    function b(a, b) {
      if ("#" === a[0] && ((a = a.replace("#", "0x")), b)) {
        if (((b = parseFloat(b)), (b = Math.min(1, Math.max(b, 0))), 0 === b))
          return "0x00000000";
        (b = (255 * b).toString(16)), 1 === b.length && (b += b), (a =
          a.slice(0, 8) + b);
      }
      return a;
    }
    ...
    if ((delete a.polyline, a.center))
      ...
      d.push(
        ["center=", a.lat, ",", a.lng].join("")
      ), delete a.lat, delete a.lng;
    else if (a.visible) {
      var i = encodeURI(a.visible.join("|"));
      d.push("visible=" + i);
    }
    var j = a.size;
    j ? (j.join && (j = j.join("x")), delete a.size) : (j = "630x300"), d.push(
      "size=" + j
    ...
    if (f)
      for (var m, n, o = 0; (c = f[o]); o++) {
        (m = []), c.size && "normal" !== c.size
          ? (m.push("size:" + c.size), delete c.size)
          : c.icon &&
            (m.push("icon:" + encodeURI(c.icon)), delete c.icon), c.color &&
          (
          ...
          ? c.address
          : c.lat + "," + c.lng), delete c.address, delete c.lat, delete c.lng;
    ...
    if (g)
      for (var o = 0; o < g.length; o++) {
        var p = [];
        g[o].featureType &&
          p.push("feature:" + g[o].featureType.toLowerCase()), g[o]
          .elementType && p.push("element:" + g[o].elementType.toLowerCase());
        for (var q = 0; q < g[o].stylers.length; q++)
          for (var r in g[o].stylers[q]) {
            var s = g[o].stylers[q][r];
            ("hue" == r || "color" == r) && (s = "0x" + s.substring(1)), p.push(
              r + ":" + s
            );
          }
        var t = p.join("|");
    ...
    return (a.hasOwnProperty("lat") && a.hasOwnProperty("lng")) ||
      ...
      ), (this.panorama = j.createPanorama(a)), this.map.setStreetView(
      this.panorama
    ), this.panorama;
  }), (j.createPanorama = function(b) {
    var c = h(b.el, b.context);
    (b.position = new google.maps.LatLng(
      b.lat,
      b.lng
    )), delete b.el, delete b.context, delete b.lat, delete b.lng;
    for (
      var d = [
          "closeclick",
          "links_changed",
    ...
    j.off(a, this);
  }), (j.custom_events = ["marker_added", "marker_removed", "polyline_added", "polyline_removed", "polygon_added", "polygon_removed", "geolocated", "geolocation_failed"]), (j.on = function(
    a,
    b,
    c
  ) {
    if (-1 == j.custom_events.indexOf(a))
      return b instanceof j && (b = b.map), google.maps.event.addListener(
        b,
        a,
        c
      );
    var d = { handler: c, eventName: a };
    return (b.registered_events[a] =
      b.registered_events[a] || []), b.registered_events[a].push(d), d;
  }), (j.off = function(a, b) {
    ...
    a.hasOwnProperty("lat") &&
      ...
      (a.latLng = new google.maps.LatLng(
        a.lat,
        a.lng
      )), delete a.lat, delete a.lng, delete a.callback, this.geocoder.geocode(
      a,
      function(a, c) {
        b(a, c);
      }
